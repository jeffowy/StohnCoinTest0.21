...
BOOST_AUTO_TEST_CASE(get_next_work)
{
    ...
    int64_t nTargetTimespan = chainParams->GetConsensus().nPowTargetTimespan;
    CBlockIndex pindexLast;
    pindexLast.nHeight = 280223;
    pindexLast.nTime = 1358378777;  // Block #280223
    pindexLast.nBits = 0x1c0ac141;
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus(), nTargetTimespan), 0x1c093f8dU);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_pow_limit)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus(), nTargetTimespan), 0x1e0fffffU);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_lower_limit_actual)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus(), nTargetTimespan), 0x1b01d73cU);
}
...
BOOST_AUTO_TEST_CASE(get_next_work_upper_limit_actual)
{
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus(), nTargetTimespan), 0x1b054c60U);
}
...
void sanity_check_chainparams(const ArgsManager& args, std::string chainName)
{
    ...
    /* STOHN: we allow overflowing by 1 bit
