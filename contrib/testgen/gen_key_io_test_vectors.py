...
bech32_templates = [
  ...
  ('soh',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('soh',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('soh',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('soh',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tsoh',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tsoh',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tsoh',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tsoh',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tsoh',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tsoh',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tsoh',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tsoh',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rsoh',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rsoh',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rsoh',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rsoh', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tsoh',   17, 32, Encoding.BECH32M, False, False, False),
  ('rsoh',  3,  1, Encoding.BECH32M, False, False, False),
  ('soh',   15, 41, Encoding.BECH32M, False, False, False),
  ('tsoh',    0, 16, Encoding.BECH32,  False, False, False),
  ('rsoh',  0, 32, Encoding.BECH32,  True,  False, False),
  ('soh',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tsoh',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rsoh',  0, 20, Encoding.BECH32,  False, False, True),
  ('soh',    0, 20, Encoding.BECH32M, False, False, False),
  ('tsoh',    0, 32, Encoding.BECH32M, False, False, False),
  ('rsoh',  0, 20, Encoding.BECH32M, False, False, False),
  ('soh',    1, 32, Encoding.BECH32,  False, False, False),
  ('tsoh',    2, 16, Encoding.BECH32,  False, False, False),
  ('rsoh', 16, 20, Encoding.BECH32,  False, False, False),
]
